<h2><a href="https://leetcode.com/problems/linked-list-components/?envType=problem-list-v2&envId=linked-list">835. Linked List Components</a></h2><h3>Medium</h3><hr><p>You are given the <code>head</code> of a linked list containing unique integer values and an integer array <code>nums</code> that is a subset of the linked list values.</p>
